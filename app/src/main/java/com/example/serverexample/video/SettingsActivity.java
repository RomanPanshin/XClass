...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            addPreferencesFromResource(com.example.serverexample.R.xml.settings);
        ...
        private void setupSenderBandwidthPreferences(String key,
            ...
            editTextPreference.setDialogLayoutResource(com.example.serverexample.R.layout.preference_dialog_number_edittext);
