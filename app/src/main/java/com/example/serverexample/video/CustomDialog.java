...
public class CustomDialog extends DialogFragment {
    ...
    String  uID="", simpleDate="", classId="", jsonurl="", jsonurl2="", result="", data="", claim="";
    ...
    CustomDialog.GetAccessToken getAccessToken = new CustomDialog.GetAccessToken();
        ...
        return builder.setTitle("Урок")
                ...
                .setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(claim.equals("teacher")) {
                            CustomDialog.GetStart getStart = new CustomDialog.GetStart();
                            getStart.execute();
